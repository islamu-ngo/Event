...
namespace Explore.Persistence.Migrations
{
    ...
    public partial class AddEventResources : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddUniqueConstraint(
                name: "ak_admission_targets_tenant_id_event_id_admission_target_type_",
                schema: "islamu_event",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    session_scope_id = table.Column<Guid>(type: "uuid", nullable: false),
                    event_resource_kind_id = table.Column<int>(type: "integer", nullable: false),
                    event_resource_delivery_type_id = table.Column<int>(type: "integer", nullable: false),
                    publication_state_id = table.Column<int>(type: "integer", nullable: false),
                    disclosure_mode_id = table.Column<int>(type: "integer", nullable: false),
                    title = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    public_title = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    description = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: true),
                    sensitive_notes = table.Column<string>(type: "character varying(5000)", maxLength: 5000, nullable: true),
                    language_code = table.Column<string>(type: "character varying(35)", maxLength: 35, nullable: true),
                    accessibility_note = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    sort_order = table.Column<int>(type: "integer", nullable: false),
                    accessible_alternative_event_resource_id = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    external_destination_protection_version = table.Column<int>(type: "integer", nullable: true),
                    external_destination_safe_origin = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    availability_absolute_start_utc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    availability_absolute_end_utc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    availability_start_anchor_id = table.Column<int>(type: "integer", nullable: true),
                    availability_start_offset_ticks = table.Column<long>(type: "bigint", nullable: true),
                    availability_end_anchor_id = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_event_resources_event_resource_delivery_types_e_01eea193103b",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_event_resources_event_resources_tenant_id_event_644632bcb5f9",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_event_resources_event_sessions_tenant_id_event__e5d4200e9785",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tenant_id = table.Column<Guid>(type: "uuid", nullable: false),
                    event_id = table.Column<Guid>(type: "uuid", nullable: false),
                    event_resource_id = table.Column<Guid>(type: "uuid", nullable: false),
                    audience_kind_id = table.Column<int>(type: "integer", nullable: false),
                    resource_event_session_id = table.Column<Guid>(type: "uuid", nullable: true),
                    resource_session_scope_id = table.Column<Guid>(type: "uuid", nullable: false),
                    event_session_id = table.Column<Guid>(type: "uuid", nullable: true),
                    event_ticket_catalog_version_id = table.Column<Guid>(type: "uuid", nullable: true),
                    event_ticket_type_id = table.Column<Guid>(type: "uuid", nullable: true),
                    admission_target_type_id = table.Column<int>(type: "integer", nullable: true),
                    admission_target_id = table.Column<Guid>(type: "uuid", nullable: true),
                    admission_target_scope_id = table.Column<Guid>(type: "uuid", nullable: true),
                    require_confirmed_order = table.Column<int>(type: "integer", nullable: false),
                    require_participant_approval = table.Column<int>(type: "integer", nullable: false),
                    require_participant_completion = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_event_resource_audience_rules_admission_targets_0b292b29daac",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_event_resource_audience_rules_event_resources_t_00c97305928f",
                    ...
                    table.ForeignKey(
                        name: "fk_event_resource_audience_rules_event_sessions_te_8837a72666fa",
                        columns: x => new { x.tenant_id, x.event_id, x.event_session_id },
                        principalSchema: "islamu_event",
                        principalTable: "event_sessions",
                        principalColumns: new[] { "tenant_id", "event_id", "id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_event_resource_audience_rules_event_ticket_cata_75909a63c295",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_event_resource_audience_rules_event_ticket_type_1918f5f14831",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tenant_id = table.Column<Guid>(type: "uuid", nullable: false),
                    event_resource_id = table.Column<Guid>(type: "uuid", nullable: false),
                    responsible_manager_user_id = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_event_resource_audit_entries_event_resources_te_372bafd99140",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_event_resources_tenant_id_event_id_accessible_a_94ba784993f5",
                schema: "islamu_event",
                table: "event_resources",
