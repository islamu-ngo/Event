...
public sealed class NativeGuestRegistrationOrderOperationTests
{
    private static readonly Type[] Requests =
    [
        // Commands (8)
        typeof(StartGuestRegistrationOrderCommand),
        typeof(ContinueGuestRegistrationOrderCommand),
        typeof(FinalizeGuestRegistrationOrderCommand),
        typeof(CancelGuestRegistrationOrderCommand),
        typeof(LaunchGuestNativeRegistrationAttemptCommand),
        typeof(LaunchGuestRegistrationProviderAttemptCommand),
        typeof(SubmitGuestNativeRegistrationAttemptCommand),
        typeof(SkipGuestNativeRegistrationRequirementCommand),

        // Queries (2)
        typeof(GetGuestRegistrationOrderQuery),
        typeof(GetGuestNativeRegistrationRequirementProgressQuery)
    ];

    [Test]
    public async Task Discovery_RegistersAllTenGuestRegistrationOrderScopedPortsWithoutLegacyShapes()
    {
