...
public static partial class CanonicalEnvironmentCatalogue
{
    ...
    private static readonly string[] AdvancedKeyData = Lines(
        ...
        ERASURE_DATABASE_HOST
        ERASURE_DATABASE_PORT
        ERASURE_DATABASE_NAME
        ERASURE_DATABASE_RUNTIME_USERNAME
        ERASURE_DATABASE_RUNTIME_PASSWORD
        ERASURE_DATABASE_MIGRATOR_USERNAME
        ERASURE_DATABASE_MIGRATOR_PASSWORD
        ERASURE_DATABASE_TLS_MODE
        ERASURE_DATABASE_TRUST_SERVER_CERTIFICATE
        """);
