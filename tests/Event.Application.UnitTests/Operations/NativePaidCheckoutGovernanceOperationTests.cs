...
public sealed class NativePaidCheckoutGovernanceOperationTests
{
    private static readonly Type[] Requests =
    [
        typeof(GetPaidCheckoutSaleControlQuery),
        typeof(StopPaidCheckoutSalesCommand),
        typeof(RequestPaidCheckoutResumeCommand),
        typeof(ReviewPaidCheckoutResumeCommand),
        typeof(RequestPaidCheckoutReviewCommand),
        typeof(DecidePaidCheckoutReviewCommand)
    ];

    [Test]
    public async Task Discovery_RegistersAllSixProtectedScopedPortsWithoutLegacyShapes()
    {
