...
public sealed record GetEventSessionCustomPropertyProjectionsForSessionQuery : IQuery<BaseCommandResponse<IReadOnlyList<EventSessionCustomPropertyProjectionDto>>>, ISecureRequest
{
