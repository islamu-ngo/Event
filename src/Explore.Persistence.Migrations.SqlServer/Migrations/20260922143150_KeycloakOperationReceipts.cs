        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    change_set = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: false),
                    target_instance_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    target_authority = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false),
                    target_authority_key = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    target_realm = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    target_client = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    ...
                    settled_at_utc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ...
                    is_cancellation_requested = table.Column<bool>(type: "bit", nullable: false),
                    step_outcomes = table.Column<string>(type: "nvarchar(max)", maxLength: 8192, nullable: false)
                },
                constraints: table =>
                {
