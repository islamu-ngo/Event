...
| E12 | `islamic-value-sensitive-design/governance/i-vsd-licensing-and-commercial-strategy.md` | Outbound model: AGPL-3.0-or-later plus CLA-backed alternative licensing; permissive dependencies preserve both paths. |
