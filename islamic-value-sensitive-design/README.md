...
| **Self-Hosting & Infra** | [`consultations/i-vsd-zero-email-notification-architecture-consultancy-report.md`](consultations/i-vsd-zero-email-notification-architecture-consultancy-report.md) | **Zero-email notification architecture**, 3-tier delivery hierarchy, W3C Web Push, dynamic Webcal, Telegram bot, and ATProto Convo. |
