...
public class UpdateActorSubscriptionNotificationLevelCommandHandler : ICommandHandler<UpdateActorSubscriptionNotificationLevelCommand, BaseCommandResponse<Guid>>
{
    ...
    public async Task<BaseCommandResponse<Guid>> ExecuteAsync(UpdateActorSubscriptionNotificationLevelCommand request, CancellationToken cancellationToken)
    {
