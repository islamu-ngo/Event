        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    session_scope_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ...
                    public_title = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    description = table.Column<string>(type: "TEXT", maxLength: 5000, nullable: true),
                    sensitive_notes = table.Column<string>(type: "TEXT", maxLength: 5000, nullable: true),
                    language_code = table.Column<string>(type: "TEXT", maxLength: 35, nullable: true),
                    accessibility_note = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    sort_order = table.Column<int>(type: "INTEGER", nullable: false),
                    accessible_alternative_event_resource_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    storage_object_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    external_destination_safe_origin = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    availability_absolute_start_utc = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    availability_absolute_end_utc = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    availability_start_anchor_id = table.Column<int>(type: "INTEGER", nullable: true),
                    availability_start_offset_ticks = table.Column<long>(type: "INTEGER", nullable: true),
                    availability_end_anchor_id = table.Column<int>(type: "INTEGER", nullable: true),
                    availability_end_offset_ticks = table.Column<long>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tenant_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    event_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    event_resource_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    audience_kind_id = table.Column<int>(type: "INTEGER", nullable: false),
                    resource_event_session_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    resource_session_scope_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    event_session_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    event_ticket_catalog_version_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    event_ticket_type_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    admission_target_type_id = table.Column<int>(type: "INTEGER", nullable: true),
                    admission_target_id = table.Column<Guid>(type: "TEXT", nullable: true),
                    admission_target_scope_id = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tenant_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    event_resource_id = table.Column<Guid>(type: "TEXT", nullable: false),
                    responsible_manager_user_id = table.Column<Guid>(type: "TEXT", nullable: true),
