...
public sealed class GetAiRunStatusQueryHandler : IQueryHandler<GetAiRunStatusQuery, AiRunDto?>
{
    ...
    public async Task<AiRunDto?> QueryAsync(GetAiRunStatusQuery request, CancellationToken cancellationToken)
    {
