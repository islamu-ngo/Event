...
public sealed class NativeGuestRegistrationStatusOperationTests
{
    private static readonly Type[] Requests =
    [
        typeof(CancelConfirmedGuestRegistrationCommand),
        typeof(GetGuestRegistrationCancellationEligibilityQuery),
        typeof(GetGuestRegistrationStatusQuery)
    ];

    [Test]
    public async Task Discovery_RegistersAllThreeProtectedScopedPortsWithoutLegacyShapes()
    {
